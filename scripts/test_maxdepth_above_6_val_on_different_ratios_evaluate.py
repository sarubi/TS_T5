...
dataset_base_dir_name=Path("/nethome/sarubi/A8/ptm_access_based_ft/TS_T5_myedit/LLM_based_control_rewrite/experiments/data_filtered_regression_model/T5_ft/f4_maxdepdepth_maxdeplength_diffwords_wc/test_maxdepdepth_above_6")

datasets_to_evaluate = {
    "gold_ratios" : "processed_data/wikilarge.test/gold_ratios",
    "fixed_ratios" : "processed_data/wikilarge.test/0_fr_ratios"
}
...
for dataset_name_key, filepath in datasets_to_evaluate.items():
    ...
    complex_source_filepath = dataset_base_dir_name / f'{filepath}/test.src'
    simple_target_filepath = dataset_base_dir_name / f'{filepath}/test.tgt'
    complex_processed_filepath = dataset_base_dir_name / f'{filepath}/test.src_processed'
...
# CUDA_VISIBLE_DEVICES=0 python scripts/test_maxdepth_above_6_val_on_different_ratios_evaluate.py > experiments/exp_1713803608466002_epoch_5_model_eval_loss/logs_TEST_maxdepth_above_6_evaluate_across_all_ratios